...
class test_LAMMPS(unittest.TestCase):
    ...
    def test_integrators(self):
        ...
        sim = l.run(ensemble=ens, potentials=pot, directory=self.directory)
        self.assertTrue(sim.lammps.has_id('fix','nve'))
        self.assertTrue(sim.lammps.has_id('fix','langevin'))
        lgv_r(sim)
        self.assertFalse(sim.lammps.has_id('fix','nve'))
        self.assertFalse(sim.lammps.has_id('fix','langevin'))
