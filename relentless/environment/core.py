...
"""
__all__ = ['Directory','Environment','Policy']
...
class Directory:
    ...
    def __init__(self, path):
        ...
        # TODO: this should check if path is a directory
    ...
    def __exit__(self, exception_type, exception_value, traceback):
        ...
        The working directory is reset to the path before entering the context.
